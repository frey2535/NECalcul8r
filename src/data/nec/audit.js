...
export const CALCULATORS = [
  ...
  // ═══ PULL BOX SIZING ═══════════════════════════════════════════════════
  {
    ...
    articles: [
      ...
      { ref: "314.28(A)(2)", desc: "Angle/U pulls or splices — 6× largest in row + sum of additional in same row; same-row spacing = 6× largest in row", changed: false, source: PEND, note: "Pending verification against authorized NFPA 70-2020. Splice sizing belongs here, not in 314.28(B)." },
      { ref: "314.28(B)", desc: "Conductors in pull or junction boxes — cable/rack conductors if any dimension exceeds 6 ft", changed: false, source: PEND, note: "Pending verification against authorized NFPA 70-2020." },
    ],
    sourceNotes: "VERIFIED WITH LIMITATIONS. Previously identified defects corrected and verified per user review: (1) applicability based on conductor size 4 AWG+, (2) 314.28(C) universal 4×4×2 minimum removed, (3) spacing uses 6× largest raceway, (4) equal-sized raceways included in 'additional' sum, (5) single raceway requires path mapping, (6) conductor-path mapping added, (7) row identification added, (8) splice sizing corrected to 314.28(A)(2), (9) spacing only between connected entries, (10) 314.28(B) clarified as conductor cabling/racking for boxes over 6 ft. Regression tests pass with independent expected values (TEST-A through TEST-G plus splice controls). NEC article sources pending verification against authorized 2020 NFPA 70 text.",
