...
def("generator_sizing", "Generator Sizing 445 / 702", calcGeneratorSizing, [
  {
    id: "gen_service_reference",
    description: "Service mode is reference-only and does not issue an NEC generator recommendation",
    inputs: { mode: "service", serviceA: 200, serviceV: 240, servicePhases: "single", demandFactor: 80, necYear: "2017" },
    expected: { serviceTotalVA: 48000, demandKW: 38.4, serviceSizingValid: false, recommendedGenSize: null },
  },
  {
    id: "gen_selected_loads",
    description: "Selected-load mode uses running load plus 25% largest motor",
    inputs: { mode: "load", criticalLoadsVA: 5000, motorLoadsVA: 3000, lightingVA: 2000, otherVA: 1000, largestMotorRunningVA: 3000, necYear: "2017" },
    expected: { totalRunningVA: 11000, requiredKW: 11.8, recommendedGenSize: 14 },
  },
  {
    id: "gen_general_2000",
    description: "2,000 ft² dwelling general load: 6,000 + 3,000 small appliance + 1,500 laundry = 10,500; demand = 5,625 VA",
    inputs: { occupancy: "residential", mode: "whole_house", necYear: "2017", squareFeet: 2000, kitchenCircuits: 2, laundryCircuits: 1 },
    expected: { generalConnectedVA: 10500, generalDemandVA: 5625 },
  },
  {
    id: "gen_range_12kw",
    description: "Single 12 kW household range demand = 8 kW",
    inputs: { occupancy: "residential", mode: "whole_house", necYear: "2017", squareFeet: 0, kitchenCircuits: 0, laundryCircuits: 0, rangeVA: 12000 },
    expected: { cookingDemandVA: 8000 },
  },
  {
    id: "gen_range_15kw",
    description: "Single 15 kW range: 8 kW Column C increased 15% = 9.2 kW",
    inputs: { occupancy: "residential", mode: "whole_house", necYear: "2017", squareFeet: 0, kitchenCircuits: 0, laundryCircuits: 0, rangeVA: 15000 },
    expected: { cookingDemandVA: 9200 },
  },
  {
    id: "gen_dryer_min",
    description: "Dwelling dryer uses 5,000 VA minimum when nameplate is lower",
    inputs: { occupancy: "residential", mode: "whole_house", necYear: "2017", squareFeet: 0, kitchenCircuits: 0, laundryCircuits: 0, dryerVA: 4200 },
    expected: { dryerDemandVA: 5000 },
  },
  {
    id: "gen_fixed_3",
  ...
  },
  {
    ...
    description: "Noncoincident heating/cooling uses the larger load",
    inputs: { occupancy: "residential", mode: "whole_house", necYear: "2017", squareFeet: 0, kitchenCircuits: 0, laundryCircuits: 0, hvacCoolingVA: 5000, hvacHeatingVA: 10000, hvacCoincidence: "noncoincident" },
    expected: { hvacDemandVA: 10000 },
  },
  {
    id: "gen_hvac_simultaneous",
  ...
  {
    id: "gen_motor_25pct",
    description: "Largest motor contributes 25% running-load adder to NEC demand",
    inputs: { occupancy: "residential", mode: "whole_house", necYear: "2017", squareFeet: 0, kitchenCircuits: 0, laundryCircuits: 0, largestMotorRunningVA: 4000 },
    expected: { largestMotorAdderVA: 1000, necDemandVA: 1000 },
  },
  {
    id: "gen_lra_separate",
    description: "Motor LRA is reported as a separate starting check, not stacked into Article 220 demand",
    inputs: { occupancy: "residential", mode: "whole_house", necYear: "2017", squareFeet: 0, kitchenCircuits: 0, laundryCircuits: 0, largestMotorLRA: 100, motorStartVoltage: 240 },
    expected: { motorStartingKVA: 24, necDemandVA: 0, wholeHouseGenSize: 24 },
  },
  {
    id: "gen_shed_range",
    description: "Managed range is excluded from standby demand only when load shedding is enabled",
    inputs: { occupancy: "residential", mode: "whole_house", necYear: "2017", squareFeet: 0, kitchenCircuits: 0, laundryCircuits: 0, rangeVA: 12000, loadSheddingEnabled: true, shedRange: true },
    expected: { cookingDemandVA: 0, shedVA: 12000 },
  },
  {
    id: "gen_no_shed_when_disabled",
    description: "Shed checkbox alone does not exclude load unless load management is enabled",
    inputs: { occupancy: "residential", mode: "whole_house", necYear: "2017", squareFeet: 0, kitchenCircuits: 0, laundryCircuits: 0, rangeVA: 12000, loadSheddingEnabled: false, shedRange: true },
    expected: { cookingDemandVA: 8000, shedVA: 0 },
  },
]);
...
export function runRemaining2017Baseline() {
  const suites = [
    suite("year_flags", "2017 year-owned flags", () => ({
      ...
      ARC_ENERGY_REDUCTION_ARTICLE: NEC.ARC_ENERGY_REDUCTION_ARTICLE,
    ...
    }), [
      {
        ...
        expected: {
          ...
          POOL_PUMP_REPLACEMENT_GFCI_REQUIRED: false,
          ...
          ARC_ENERGY_REDUCTION_ARTICLE: "240.87",
