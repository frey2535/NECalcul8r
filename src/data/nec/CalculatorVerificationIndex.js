...
export const VERIFICATION_RESULTS = {
  dwelling_standard: {
    ...
    completeDependencyList: [
      ...
      "230.42(B) (minimum dwelling service 100A)",
    ...
    runtimeDependenciesVerified: [
      ...
      "DWELLING_MIN_SERVICE_AMPS = 100 (NEC 230.42(B), now explicit in all year files)",
    ],
  ...
  dwelling_optional: {
    ...
    runtimeDependenciesVerified: [
      ...
      "STD_OCPD_SIZES (NEC 240.6(A), unchanged)",
      "DWELLING_MIN_SERVICE_AMPS = 100 (NEC 230.42(B), explicit in all year files)",
    ],
