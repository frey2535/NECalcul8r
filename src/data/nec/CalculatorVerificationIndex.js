...
export const VERIFICATION_RESULTS = {
  ...
  commercial_load: {
    ...
    completeDependencyList: [
      ...
      "220.14(E) (outside sign — min 1200 VA)",
      "220.14(K) (office/bank — 1 VA/sq ft minimum)",
    ...
    ruleVerification: {
      ...
      "220.14(E)": { status: "VERIFIED", detail: "Outside sign load uses max(user-entered VA, 1200 VA) when a sign load is entered." },
      "220.14(K)": { status: "VERIFIED", detail: "Office/bank 1 VA/sq ft receptacle minimum is compared against the 220.44 demand result; the larger value is used." },
    ...
    runtimeDependenciesVerified: [
      ...
      "Sign outlet minimum 1200 VA when entered (220.14(E))",
      "Receptacle 180 VA/yoke (220.14(I))",
      "Office/bank receptacle minimum 1 VA/sq ft (220.14(K))",
    ],
