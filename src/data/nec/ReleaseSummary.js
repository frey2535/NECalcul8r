...
export const RELEASE_SUMMARY = {
  ...
  calculators: [
    ...
    // ─── Pending calculators (in review order) ────────────────────────────
    {
      ...
      ready: "✅",
      lastReviewed: "2026-08-22",
      notes: "2017 gated: Table 220.12 occupancies + unlisted 2 VA/ft², Table 220.42 hotel/hospital/warehouse + footnote, 220.14(I)(F sign/outline)(G show windows)(K), 220.44. FROZEN BASELINE v1.0.0 (11 tests). 2020 gated separately: hotel 1.70 / hospital 1.6 / garage 0.3 / armory 1.7; remaining occupancies pending placeholders. 2023 references are reorganized to 220.41 for dwelling lighting, Table 220.42(A) for non-dwelling unit loads, Table 220.45 for demand factors, and 220.47 for receptacle demand.",
    ...
    { calculator: "Receptacle Load", id: "receptacle_load", status: "✅ VERIFIED — FROZEN BASELINE GATE", defectsFound: 0, defectsFixed: 0, ready: "✅", lastReviewed: "2026-08-22", notes: "2017 gated: 220.14(I) 180 VA yoke, 220.44 first 10 kVA 100%/remainder 50%. 2023 display maps receptacle demand to 220.47. Year yoke VA from RECEPTACLE_YOKE_VA. FROZEN in remaining-2017 v1.0.0.", baselineGate: { frozen: true, version: "1.0.0", date: "2026-08-22", totalTests: 5 } },
    ...
    { calculator: "EV Charging", id: "ev_charging", status: "✅ VERIFIED — FROZEN BASELINE GATE", defectsFound: 2, defectsFixed: 2, ready: "✅", lastReviewed: "2026-09-06", notes: "2017 gated: 625.41/625.42 125%, 625.54 EV charging receptacle GFCI required for covered receptacles, no 220.57 service-load minimum, no 230.67/230.85. FROZEN in remaining-2017 v1.0.0. 2020: same 125%; 625.54 GFCI true; SPD/disconnect true; still no 220.57 service-load minimum. 2023 7200VA item corrected to 220.57 service/load note, not 625.42(A) branch-circuit sizing.", baselineGate: { frozen: true, version: "1.0.0", date: "2026-08-22", totalTests: 2 } },
    ...
    { calculator: "Data Center", id: "data_center", status: "✅ MATH REVIEWED — NO CODEBOOK VERIFICATION REQUIRED", defectsFound: 0, defectsFixed: 0, ready: "✅", lastReviewed: "2026-08-22", notes: "Engineering PUE/redundancy/UPS load planning calculator. Not codebook-derived and no longer requires Codebook Matrix article verification. FROZEN in remaining-2017 v1.0.0.", baselineGate: { frozen: true, version: "1.0.0", date: "2026-08-22", totalTests: 1 } },
    ...
    { calculator: "Demand Factor", id: "demand_factor", status: "✅ VERIFIED — FROZEN BASELINE GATE", defectsFound: 0, defectsFixed: 0, ready: "✅", lastReviewed: "2026-08-22", notes: "2017 gated: 220.42 dwelling/hotel/warehouse, 220.44, 220.53 75%, 220.61(B)(1) 70%. 2023 display maps receptacle demand to 220.47. 220.61(B)(2) ampere path is Neutral Load. FROZEN in remaining-2017 v1.0.0.", baselineGate: { frozen: true, version: "1.0.0", date: "2026-08-22", totalTests: 5 } },
    { calculator: "Voltage Drop", id: "voltage_drop", status: "✅ VERIFIED — FROZEN BASELINE GATE", defectsFound: 0, defectsFixed: 0, ready: "✅", lastReviewed: "2026-08-22", notes: "2017 gated: NEC Ch.9 Table 8 CM values. K=12.9 Cu / 21.2 Al are engineering constants, not specifically listed in the NEC. 3%/5% are informational notes, not mandatory Code requirements. FROZEN in remaining-2017 v1.0.0.", baselineGate: { frozen: true, version: "1.0.0", date: "2026-08-22", totalTests: 1 } },
    ...
    { calculator: "Multiwire Branch Circuits", id: "multiwire_branch", status: "✅ VERIFIED — FROZEN BASELINE GATE", defectsFound: 0, defectsFixed: 0, ready: "✅", lastReviewed: "2026-08-22", notes: "2017 gated: 210.4(B) handle-tie + 120/240 V |A−B| and 3Ø 4W vector neutral. FROZEN in remaining-2017 v1.0.0.", baselineGate: { frozen: true, version: "1.0.0", date: "2026-08-22", totalTests: 2 } },
