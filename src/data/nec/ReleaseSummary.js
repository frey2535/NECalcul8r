...
export const RELEASE_SUMMARY = {
  ...
  calculators: [
    ...
    { calculator: "EV Charging", id: "ev_charging", status: "✅ VERIFIED — FROZEN BASELINE GATE", defectsFound: 1, defectsFixed: 1, ready: "✅", lastReviewed: "2026-09-05", notes: "2017 gated: 625.42 125%, 625.54 EV charging receptacle GFCI required, EV_MINIMUM_LOAD_VA=0, no 230.67/230.85. FROZEN in remaining-2017 v1.0.0. 2020: same 125%; 625.54 GFCI true; SPD/disconnect true; still no min load VA.", baselineGate: { frozen: true, version: "1.0.0", date: "2026-08-22", totalTests: 2 } },
