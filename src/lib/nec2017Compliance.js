...
export const POST_2017_ARTICLES = {
  ...
  "210.8(E)": { addedIn: "2020", description: "GFCI for equipment-servicing receptacles" },
  "210.8(F)": { addedIn: "2020", description: "GFCI for outdoor dwelling outlets on larger circuits" },
  "240.67": { addedIn: "2020 effective date", description: "Fuse arc-energy-reduction rule was not effective until January 1, 2020" },
  "680.21(D)": { addedIn: "2020", description: "Replacement pool pump motor GFCI rule" },
...
export const YEAR_SENSITIVE_FIELDS = {
  ...
  GFCI_EQUIPMENT_SERVICING_RECEPTACLE: { nec2017: null,    changedIn: "2020", article: "210.8(E)",    note: "210.8(E) did not exist in 2017" },
  GFCI_OUTDOOR_DWELLING_50A:           { nec2017: null,    changedIn: "2020", article: "210.8(F)",    note: "210.8(F) did not exist in 2017" },
  POOL_PUMP_REPLACEMENT_GFCI_REQUIRED: { nec2017: false,   changedIn: "2020", article: "680.21(D)",   note: "680.21(D) did not exist in 2017" },
  ARC_ENERGY_REDUCTION_FUSE_ARTICLE:   { nec2017: null,    changedIn: "2020 effective date", article: "240.67", note: "240.67 was not effective for the 2017 model until Jan. 1, 2020" },
...
export const VALID_2017_ARTICLES = new Set([
  "110.9", "110.10", "110.14(C)", "110.26",
  "210.4", "210.4(B)", "210.8", "210.8(A)", "210.11", "210.12", "210.19", "210.19(A)(1)", "210.52", "210.52(C)",
