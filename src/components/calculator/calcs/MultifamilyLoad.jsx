  ...
  return (
    <CalcLayout category={category} necYear={necYear} inputValues={v} outputValues={r} result={
      <div className="space-y-2">
        ...
        <NoteBox>
          NEC {necYear} 220.84: Optional method for a feeder or service supplying three or more dwelling units of a multifamily dwelling, if no unit is supplied by more than one feeder and each unit has electric cooking. Per-unit load is 220.84(C): general lighting ({nec.DWELLING_LIGHTING_VA_PER_SQFT} VA/ft²), 1500 VA per 210.11(C)(1) small-appliance circuit and 210.11(C)(2) laundry circuit, nameplate fastened appliances and motors, and the larger of air-conditioning or space heating. Table 220.84 applies to that connected unit load. House loads are calculated under Part III and added (220.84(B)). {necYear === "2017" || necYear === "2020" ? `${necYear} Table 220.84: 51–55 units at 25%; 56–61 units at 24%; 62 and over at 23%.` : ""} Common laundry facilities may omit in-unit laundry circuits (210.52(F) Exception). Neutral (220.61) and 3-phase range phase-leg balancing (Annex D D5(b)) are not in this calculator.
        </NoteBox>
      </div>
    }>
