...
async function main() {
  ...
  try {
    const { runMarinaShorePowerBaseline } = await server.ssrLoadModule("/src/data/nec/marinaShorePowerBaseline.js");
    const results = runMarinaShorePowerBaseline();
    console.log("");
    console.log("  MARINA SHORE POWER (NEC Table 555.12) — 2017 BASELINE");
