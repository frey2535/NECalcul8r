...
assert(configuredStarterAccess.includedCount === 16, "configured individual_6_15 should include its 15 tier calculators plus always-free Electrical Fundamentals");
...
assert(configuredAdvancedAccess.includedCount === 36, "configured individual_26_35 should include its 35 tier calculators plus always-free Electrical Fundamentals");
