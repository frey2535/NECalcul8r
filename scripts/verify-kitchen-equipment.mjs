...
async function main() {
  ...
  try {
    const { runKitchenEquipmentBaseline } = await server.ssrLoadModule("/src/data/nec/kitchenEquipmentBaseline.js");
    const results = runKitchenEquipmentBaseline();
    console.log("");
    console.log("  KITCHEN EQUIPMENT (NEC 220.56) — 2017 BASELINE");
